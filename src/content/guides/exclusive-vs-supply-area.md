---
title: "전용면적 vs 공급면적 완벽 해설: 실제 사용 공간 정확히 파악하기"
description: "부동산에서 가장 혼란스러운 개념인 전용면적과 공급면적의 차이를 명확히 설명합니다. 전용률 계산법과 실제 거주 공간을 정확히 파악하는 방법을 알아보고 현명한 부동산 결정을 내리세요."
publishDate: 2024-01-15
canonical: "https://pyeongsu-calculator.kr/guide/exclusive-vs-supply-area"
keywords:
  - 전용면적
  - 공급면적
  - 계약면적
...
faqs:
  - question: "전용면적과 공급면적의 차이는 무엇인가요?"
    answer: "전용면적은 세대가 독점적으로 사용하는 실내 공간(방, 거실, 주방, 화장실)이고, 공급면적은 전용면적에 계단, 복도, 엘리베이터 홀 등 주거공용면적을 더한 것입니다. 일반적으로 공급면적은 전용면적보다 20~30% 큽니다."
  - question: "34평형 아파트의 실제 전용면적은 얼마나 되나요?"
    answer: "34평형은 공급면적 기준이며, 전용면적은 보통 84㎡(약 25.7평) 정도입니다. 나머지 약 8~9평은 계단, 복도, 엘리베이터 홀 등의 주거공용면적입니다. 따라서 실제 거주 공간은 25평 정도로 보면 됩니다."
  - question: "전용률이 높으면 무엇이 좋은가요?"
    answer: "전용률은 공급면적 대비 전용면적의 비율입니다. 전용률이 높을수록 같은 분양가에서 실제 거주 공간이 넓다는 의미이므로, 공용 공간 대비 전용 공간을 많이 확보할 수 있어 유리합니다. 일반적으로 75~80% 수준입니다."
---
...
<p class="font-semibold mb-2">주의: 발코니는 전용면적에 포함되지 않습니다</p>
<p class="m-0">
...
<div class="info-box">
<p class="font-semibold mb-2">공급면적 계산 공식</p>
...
<div class="info-box">
<p class="font-semibold mb-2">계약면적 계산 공식</p>
<p class="m-0 font-mono">
계약면적 = 공급면적 + 기타공용면적<br>
= 전용면적 + 주거공용면적 + 기타공용면적
</p>
...
- 전용 84㎡ 아파트의 경우 약 10~15㎡(약 3~4.5평)의 공간이 추가됩니다.
- 실제 사용 가능 면적이 약 100㎡에 가까워집니다.
...
면적 변환이 필요하시면 [평수 계산기](/)를 활용해 보세요. 제곱미터와 평 사이의 변환을 실시간으로 확인하고, 자주 사용하는 평형 정보도 한눈에 파악할 수 있습니다.
